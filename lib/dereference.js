...
function dereference$Ref ($ref, path, pathFromRoot, parents, $refs, options) {
  ...
  if (circular && !directCircular) {
    // FIXME I'm not sure what this should be. If you assign $ref it results
    // in a _different_ error on the browser when displaying the output.
    // https://github.com/APIDevTools/json-schema-ref-parser/issues/112
    // https://github.com/maxdome/swagger-combine/issues/63
    dereferencedValue = {};
  }
